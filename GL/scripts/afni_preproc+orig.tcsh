...
echo "auto-generated by afni_proc.py, Fri Apr 22 12:29:01 2022"
echo "(version 7.17, July 16, 2021)"
echo "execution started: `date`"

# to execute via tcsh: 
#   tcsh -xef /home/sungbeenpark/Github/labs/GL/scripts/afni_preproc.tcsh |& tee /home/sungbeenpark/Github/labs/GL/scripts/output.afni_preproc.tcsh
# to execute via bash: 
#   tcsh -xef /home/sungbeenpark/Github/labs/GL/scripts/afni_preproc.tcsh 2>&1 | tee /home/sungbeenpark/Github/labs/GL/scripts/output.afni_preproc.tcsh
...
set output_dir = /mnt/sdb2/GL/fmri_data/preproc_data/$subj/orig
...
foreach run ( $runs )
    ...
    3dAllineate -base ${subj}.MPRAGE_unif_ns+orig                  \
...
cat_matvec -ONELINE ${subj}.MPRAGE_unif_al_junk_mat.aff12.1D -I  > \
...
3dcopy ${subj}.MPRAGE_unif_ns+orig anat_final.$subj
...
3dresample -master full_mask.$subj+orig -input ${subj}.MPRAGE_unif_ns+orig \
...
#
# afni_proc.py -subj_id GL03 -script                                          \
#     /home/sungbeenpark/Github/labs/GL/scripts/afni_preproc.tcsh -out_dir    \
#     /mnt/sdb2/GL/fmri_data/preproc_data/ -dsets                             \
#     /mnt/sda2/GL/fmri_data/GL03/func.GL03.r02+orig.HEAD                     \
#     /mnt/sda2/GL/fmri_data/GL03/func.GL03.r03+orig.HEAD                     \
#     /mnt/sda2/GL/fmri_data/GL03/func.GL03.r04+orig.HEAD                     \
#     /mnt/sda2/GL/fmri_data/GL03/func.GL03.r05+orig.HEAD -blocks despike     \
#     tshift align volreg blur mask scale regress -copy_anat                  \
#     /mnt/sda2/GL/fmri_data/GL03/GL03.MPRAGE+orig -anat_has_skull yes        \
#     -anat_uniform_method unifize -anat_unif_GM yes -tcat_remove_first_trs 0 \
#     -tshift_opts_ts -tpattern alt+z2 -align_opts_aea -cost lpc+ZZ           \
#     -giant_move -check_flip -volreg_align_e2a -volreg_align_to MIN_OUTLIER  \
#     -blur_size 4.0 -regress_stim_times                                      \
#     /mnt/sda2/GL/behavior_data/regressors/GL03_RewFB.txt                    \
#     /mnt/sda2/GL/behavior_data/regressors/GL03_RewnFB.txt                   \
