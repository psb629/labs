...
set dir_preproc = /mnt/sdb2/GL/fmri_data/preproc_data/$subj
...
cp -n $dir_preproc/anat_final.$subj+orig.* $dir_output
# -------------------------------------------------------
...
3dDeconvolve -input $dir_preproc/pb05.$subj.r*.scale+orig.HEAD		\
    -censor $dir_preproc/censor_${subj}_combined_2.1D				\
	-mask $dir_preproc/full_mask.$subj+orig						\
