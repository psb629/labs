...
set subj_list = (TML20 TML21 TML22 TML23 TML24 TML25 TML26 TML28 TML29)
set output_reg_num = Reg6
set stat_name = {$output_reg_num}_MVPA2_IM_VWM	# Vibration / Working-memory / Motor respones
...
foreach subj ($subj_list)
	...
	set reg_file = $reg_subj_dir/onset+duration_VWM.dat
