...
foreach subj ($subj_list)
	...
	set run1_dir = $root_dir/$subj/RUN1_MB3_2ISO__0003
	set run2_dir = $root_dir/$subj/RUN2_MB3_2ISO__0004
	set run3_dir = $root_dir/$subj/RUN3_MB3_2ISO__0005
	set run4_dir = $root_dir/$subj/RUN4_MB3_2ISO__0007
	set run5_dir = $root_dir/$subj/RUN5_MB3_2ISO__0008
...
foreach subj ($subj_list)
	...
	set pref = /clmnlab/TM/fMRI_data/masks/full_masks/full_mask.{$subj}.nii.gz
	if (! -e $pref) then
